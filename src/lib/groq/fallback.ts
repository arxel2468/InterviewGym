...
const FALLBACK_MESSAGES = {
  tts: {
    degraded: "We're experiencing high demand. You've been connected to our backup interviewer — they're a bit robotic, but still helpful!",
    failed: "All our interviewers are stuck in meetings. Please try again in a few minutes, or practice with a friend in the meantime!",
  },
  ...
  chat: {
    degraded: "Our senior interviewers are swamped with candidates. You've been connected to a junior interviewer — they're still learning, but eager to help!",
    failed: "All our interviewers are in back-to-back meetings. Even the interns are busy! Please grab a coffee and come back in a bit.",
  },
}
