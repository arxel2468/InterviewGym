...
export const BEHAVIORAL_QUESTIONS: Question[] = [
  // INTRO
  {
    id: 'intro_1',
    category: 'intro',
    question: "Before we dive in, tell me briefly about yourself and what brings you here today.",
    followUps: [
  ...
  // TEAMWORK
  {
    id: 'team_1',
    category: 'teamwork',
    question: "Tell me about a time you had to work closely with someone whose working style was very different from yours.",
    followUps: [
  ...
  // CONFLICT
  {
    id: 'conflict_1',
    category: 'conflict',
    question: "Tell me about a time you disagreed with your manager or a senior colleague. How did you handle it?",
    followUps: [
  ...
  },
  {
    id: 'conflict_2',
    category: 'conflict',
    question: "Describe a situation where two stakeholders wanted different things from you. How did you navigate that?",
    followUps: [
  ...
  // FAILURE
  {
    id: 'failure_1',
    category: 'failure',
    question: "Tell me about a time you failed or made a significant mistake at work.",
    followUps: [
  ...
  },
  {
    id: 'achieve_2',
    category: 'achievement',
    question: "Tell me about a time you exceeded expectations on a project or task.",
    followUps: [
  ...
  // PROBLEM SOLVING
  {
    ...
    question: "Describe a complex problem you had to solve with limited information or resources.",
    followUps: [
  ...
  },
  {
    id: 'problem_2',
    category: 'problem_solving',
    question: "Tell me about a time you had to learn something quickly to solve a problem.",
    followUps: [
  ...
  // PRESSURE
  {
    id: 'pressure_1',
    category: 'pressure',
    question: "Tell me about a time you had to deliver results under a tight deadline.",
    followUps: [
  ...
  },
  {
    id: 'pressure_2',
    category: 'pressure',
    question: "Describe a high-stakes situation where you had to make a decision quickly.",
    followUps: [
  ...
  // LEADERSHIP
  {
    id: 'lead_1',
    category: 'leadership',
    question: "Tell me about a time you took the lead on something without being asked.",
    followUps: [
      "Why did you step up?",
  ...
  },
  {
    id: 'lead_2',
    category: 'leadership',
    question: "Describe a situation where you had to motivate others or get buy-in for an idea.",
    followUps: [
  ...
  // GROWTH
  {
    id: 'growth_1',
    category: 'growth',
    question: "What's the most valuable feedback you've ever received, and how did you act on it?",
    followUps: [
      "Was it hard to hear?",
  ...
  // CLOSING
  {
    id: 'closing_1',
    category: 'closing',
    question: "Is there anything about your experience or skills that we haven't covered that you'd like to share?",
    followUps: [],
...
export function selectQuestionsForSession(count: number = 5): Question[] {
  ...
  const middleCategories: QuestionCategory[] = [
    'teamwork', 'conflict', 'failure', 'achievement', 
    'problem_solving', 'pressure', 'leadership'
  ]
  ...
  for (const category of categoriesToCover) {
    const questions = BEHAVIORAL_QUESTIONS.filter(q => q.category === category)
  ...
  const closingQs = BEHAVIORAL_QUESTIONS.filter(q => 
    q.category === 'closing' || q.category === 'motivation'
  )
